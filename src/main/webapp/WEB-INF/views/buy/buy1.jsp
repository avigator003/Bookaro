        				...
        				<div class="tab__container">
	        				<div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
	        					<div class="row">
	        						...
	        						<qu:forEach items="${book1}" var="book">
	        				
	        					
	        						<qu:forEach  items="${books1[count]}" var="pics">
	        				
	        						<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product__thumb">
											<a class="first__img" href="single-product.html"><img src="data:image/jpg;base64,${pics}"></a>
											<a class="second__img animation1" href="single-product.html"><img src="data:image/jpg;base64,${pics}"></a>
											
										</div>
										<div class="product__content content--center">
											<h4><a href="single-product.html"><qu:out value="${book.getSubject()}"></qu:out>--<qu:out value="${book.getAuthor()}"></qu:out></a></h4>
											<ul class="prize d-flex">
												<li>PRICE  :<qu:out value="${book.getPrice()}"></qu:out></li>
											
											</ul>
											<div class="action">
												<div class="actions_inner">
													<ul class="add_to_links">
														<li><a class="wishlist" href="<%=path%>/bookaro/AddCart/${book.getBid()}"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a></li>
