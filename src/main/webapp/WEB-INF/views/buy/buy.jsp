	        					...
	        					<div class="row">
	        						...
	        						<div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
			        					<div class="product__thumb">
											<a class="first__img" href="single-product.html"><img src="data:image/png;base64,${book.bookPic}"></a>
											<a class="second__img animation1" href="single-product.html"><img src="data:image/png;base64,${book.bookPic}"></a>
