                                ...
                                <table>
                                    <thead>
                                        <tr class="title-top">
                                            ...
                                            <th class="product-name">Subject Name</th>
                                    ...
                                    <qu:forEach items="${cart}" var="book">
                                        ...
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img src="data:image/png;base64,${book.getBookPic()}"></a></td>
                                            <td class="product-name"><a href="#">${book.getBookSubject()}</a></td>
                                            <td class="product-price"><span class="amount">${book.getBookPrice()} Rs.</span></td>
                                            <qu:set var="total" value="${total+(book.getBookPrice()*book.getQuantity())}"></qu:set>
                                            <td class="product-quantity" style="font-weight: bold">${book.getQuantity()}</td>
