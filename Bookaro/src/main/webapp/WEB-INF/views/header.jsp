				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-6 col-lg-2">
						<ul class="header__sidebar__right d-flex justify-content-end align-items-center">
							...
							<li class="shopcart"><a class="cartbox_active" href="#"><span class="product_qun">${quantity}</span></a>
								<!-- Start Shopping Cart -->
                                    	...
                                    	<div class="single__items">
											<div class="miniproduct">
												<div class="item01 d-flex">
													<div class="thumb">
													<a href="product-details.html"><img src="data:image/jpg;base64,${pic}"></a></td>
													</div>
													<div class="content">
														<h6><a href="product-details.html">${book.getSubject()}</a></h6>
														<span class="prize">${book.getPrice()} Rs.</span>
