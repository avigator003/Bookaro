...
<head>
    ...
    <!-- Bootstrap-Core-CSS -->
    <link rel="stylesheet" href="/css/index/index.css" type="text/css" media="all" />
    <!-- Style-CSS -->
    <!-- font-awesome-icons -->
...
<body>
        ...
        <header class="py-sm-3 pt-3 pb-2" id="home">
            <div class="container">
                ...
                <div class="top-w3pvt d-flex">
                    <div id="logo">
                        <h1> <a href="index.html"><span class="log-w3pvt">B</span>ookaro</a> <label class="sub-des">Online Store</label></h1>
                    </div>

                    <div class="forms ml-auto">
                        <a href="<%=path%>/bookaro/loginform" class="btn"><span class="fa fa-user-circle-o"></span> Sign In</a>
                        <a href="<%=path%>/bookaro/registerform" class="btn"><span class="fa fa-pencil-square-o"></span> Sign Up</a>
                    </div>
                </div>
        ...
        <div class="banner-wthree-info container">
            <div class="row">
                <div class="col-lg-5 banner-left-info">
                    <h3>The Largest Book Store<span>is Here!!</span></h3>
                    <a href="shop.html" class="btn shop">Buy Now</a>
                </div>

                <div class="col-lg-7 banner-img">
                    <img src="/images/book.png" alt="part image" class="img-fluid" style="border-radius: 130px;height: 280px;width: 280px;position: absolute;top:60px;left:170px">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row grids-wthree-info text-center">
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        ...
                        <p>Tensio free Service is now Here!!</p>
                    </div>
                </div>
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                ...
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        ...
                        <p>Books are Not Your Choice return With any tension.</p>
                    </div>
                </div>
        ...
        <div class="container py-md-5">
            <div class="row">
                <div class="col-lg-3 footer_wthree_gridf mt-lg-5">
                    <h2><a href="index.html"><span>B</span>ookaro
                        </a> </h2>
    ...
    <div class="cpy-right text-center py-3">
        <p>© 2020 Bookaro. All rights reserved | Design by
            <a href="http://w3layouts.com"> Avigator.</a>
        </p>
